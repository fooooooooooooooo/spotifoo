...
module.exports = React.memo(
  ({ getSetting, toggleSetting, patch }) => (
    <div>
      <SwitchItem
        note='Use webnowplaying + Spicetify for missing features with no spotify premium'
        value={getSetting('webnowplaying', false)}
        onChange={() => toggleSetting('webnowplaying')}
      >
        Use webnowplaying and Spicetify
      </SwitchItem>
